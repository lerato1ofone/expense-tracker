...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    public List<Category> findAll(Integer userId) throws EtResourceNotFoundException {
        try {
            ...
            throw new EtResourceNotFoundException("No categories found");
        }
    }
    ...
    public Integer create(Integer userId, String title, String description) throws EtBadRequestException {
        try {
            ...
            throw new EtBadRequestException("Invalid request details. Failed to create category");
        }
    }
    ...
    public void update(Integer userId, Integer categoryId, Category category) throws EtBadRequestException {
        try {
            ...
            throw new EtBadRequestException("Invalid request details. Failed to update category");
        }
    }
    ...
    private RowMapper<Category> categoryRowMapper = ((rs, rowNumber) -> {
